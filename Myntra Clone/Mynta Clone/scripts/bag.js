...
//      <span class="discount-percentage">(0% ${item.discount_percentage} OFF)</span>
//    </div>
...
function generateItemHTML(item){
   ...
   <div class="bag-item-container">
             ...
             <div class="item-right-part">
               ...
               <div class="return-period">${item.return_period}
                 <span class="return-period-days">14days</span> return available
               </div>
               <div class="delivery-details">
                 Delivery by
